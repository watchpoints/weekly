...
- D:\db\oceanbase\unittest\share\CMakeLists.txt
  ...
  ~~~
          modified:   deps/oblib/src/lib/CMakeLists.txt
          modified:   deps/oblib/src/lib/geo/ob_geo_func_register.h
          modified:   deps/oblib/src/lib/ob_name_def.h
          modified:   src/objit/include/objit/common/ob_item_type.h
          modified:   src/sql/CMakeLists.txt
          modified:   src/sql/engine/expr/ob_expr_eval_functions.cpp
          modified:   src/sql/engine/expr/ob_expr_operator_factory.cpp
          modified:   src/sql/engine/expr/ob_expr_st_distance_sphere.cpp
          modified:   src/sql/resolver/expr/ob_raw_expr.h
          modified:   unittest/share/CMakeLists.txt
          modified:   unittest/share/test_geo_func_union.cpp
  
  Untracked files:
    (use "git add <file>..." to include in what will be committed)
          deps/oblib/src/lib/geo/ob_geo_func_exterior_ring.cpp
          deps/oblib/src/lib/geo/ob_geo_func_exterior_ring.h
          src/sql/engine/expr/ob_expr_st_exterior_ring.cpp
          src/sql/engine/expr/ob_expr_st_exterior_ring.h
...
git push --set-upstream oceanbase issue_1400
origin 是默认的远程版本库名称

等价于git push oceanbase issue_1400:issue_1400 
