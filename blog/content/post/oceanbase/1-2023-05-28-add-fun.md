...
- 参考 https://github.com/boostorg/geometry/tree/develop 写一个 Boost.Geometry ExteriorRing 例子 
...
unittest/share/test_geo_func_union.cpp 代码分析



~~~
1.定义  class TestGeoFuncUnion : public ::testing::Test
...
error: Your local changes to the following files would be overwritten by merge:
        unittest/share/test_geo_func_union.cpp
