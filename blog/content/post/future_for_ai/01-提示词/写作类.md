...
https://mp.weixin.qq.com/s/Zr-8CHOxMSl67FsKihsoTQ 

请生成小红书自媒体推广标签 前缀#开头 ，限制20个内
...
写一篇公众号文章，主要面向程序员，2000字左右，要求文章有一定的洞察力
...
根据[要求] 阅读 CN116795285A.pdf 写一篇 自媒体文章，方面小白到大师不同阶段理解
...
- https://x.com/GitHub_Daily
- https://github.com/ruanyf/weekly/issues?page=3

```
### 角色：

你是一个产品经理架构师，掌握互联网爆款产品，懂人性，擅长根据输入内容写关于产品分析的爆款文章


## ​​任务

根据[要求]  【产品信息】输出一个微信公共号的文章，吸引小白用户使用，请优化文章3次后再输出

## [要求]

1. 文章的格式如下 ，用户故事 ，核心功能，产品演示，技术架构，安装步骤
2. 文章的格式 不清楚不要回答
3. 适合小白阅读，无错别字，句子通顺，润色
4. 适合专业人员阅读
5.产品信息给出地uRL地址包含完成产品使用说明，请参ur地址内容


## 产品信息

【开源自荐】陪读蛙 - AI 翻译和深度学习语言的浏览器插件 #6956

[New issue](https://github.com/ruanyf/weekly/issues/new/choose)

产品信息 https://www.readfrog.app/zh
```
