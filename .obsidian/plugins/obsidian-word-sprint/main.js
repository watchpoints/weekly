...
class EndOfSprintStatsModal extends obsidian.Modal {
    constructor(...params) {
        super(params[0]);
        if (params.length === 2) {
    ...
    renderStats(contentEl) {
        ...
        if (this.sprintHistory && this.sprintHistory.length > 1) {
            new obsidian.Setting(contentEl)
                .setName("Sprint Date")
                .addText((text) => {
                text.setValue(obsidian.moment(this.sprintRunStat.created).format('YYYY-MM-DD HH:mm:ss'));
...
class NanowrimoApi {
    ...
    getCurrentUser() {
        return __awaiter(this, void 0, void 0, function* () {
            const currentUserData = yield obsidian.request({
                method: 'GET',
    ...
    getUser(username) {
        return __awaiter(this, void 0, void 0, function* () {
            const userData = yield obsidian.request({
                method: 'GET',
    ...
    getProjects(userId) {
        return __awaiter(this, void 0, void 0, function* () {
            const projectsResponse = yield obsidian.request({
                method: 'GET',
    ...
    getProjectChallenges(projectId) {
        return __awaiter(this, void 0, void 0, function* () {
            const projectChallengesResponse = yield obsidian.request({
                method: 'GET',
    ...
    updateProject(projectId, projectChallengeId, sprintCount) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const result = yield obsidian.request({
                method: 'POST',
        ...
        if (this.plugin.settings.nanowrimoAuthToken && this.plugin.settings.nanowrimoUserId) {
            new obsidian.Setting(containerEl)
                ...
                const options = projectsResponse.data.reduce((existing, project) => {
                    return Object.assign(Object.assign({}, existing), { [project.id]: project.attributes.title });
                }, { 0: 'Select A Project' });
            ...
            if (this.plugin.settings.nanowrimoProjectId) {
                new obsidian.Setting(containerEl)
                    ...
                    const options = projectChallengesResponse.data.reduce((existing, projectChallenge) => {
                        return Object.assign(Object.assign({}, existing), { [projectChallenge.id]: projectChallenge.attributes.name });
                    }, { 0: 'Select A Project' });
                    dropdown.addOptions(options);
...
class SprintRun {
    ...
    getMiniStats() {
        const aggregateMetrics = Array.from(this.fileMetrics.values()).reduce((acc, curr) => ({
...
const PluginContext = reactExports.createContext(undefined);

const usePlugin = () => {
    return reactExports.useContext(PluginContext);
};
...
const StatReactView = () => {
    ...
    const [activeTab, setActiveTab] = reactExports.useState(plugin.settings.defaultTab);
    const [totalWordCount, setTotalWordCount] = reactExports.useState(0);
    const [dailyWordCount, setDailyWordCount] = reactExports.useState(0);
    const [wordCount, setWordCount] = reactExports.useState(null);
    const [secondsLeft, setSecondsLeft] = reactExports.useState(null);
    const [status, setStatus] = reactExports.useState(null);
    const [statsAvailable, setStatsAvailable] = reactExports.useState(false);
    const [isSprintStarted, setIsSprintStarted] = reactExports.useState(false);
    const [dailyGoal, setDailyGoal] = reactExports.useState(null);
    const [overallGoal, setOverallGoal] = reactExports.useState(null);
    const [sprintLength, setSprintLength] = reactExports.useState(plugin.theSprint.sprintLength);
    ...
    return (reactExports.createElement("div", { id: "wordsprint" },
        isSprintStarted && (reactExports.createElement(reactExports.Fragment, null,
            reactExports.createElement("div", { className: `status ${renderStatusClass(status)}` }, renderStatusName(status)),
            reactExports.createElement("div", { className: "secondsLeft" }, secondsLeft),
            reactExports.createElement("div", { className: "wordsWritten" },
                wordCount,
                " words written"))),
        !isSprintStarted && (reactExports.createElement(reactExports.Fragment, null,
            reactExports.createElement("div", { className: `status ${renderStatusClass(status)}` }, renderStatusName(status)),
            reactExports.createElement("div", { className: "hand secondsLeft", onClick: () => { plugin.showChangeSprintTimeModal(); } }, secondsToMMSS(sprintLength * 60)))),
        reactExports.createElement("div", { id: "sprintActionPanel" },
            reactExports.createElement("button", { className: "sprintStart", disabled: isSprintStarted, style: { opacity: isSprintStarted ? 0.4 : 1 }, onClick: () => { startSprint(); } }, "Start"),
            reactExports.createElement("button", { className: "sprintStop", disabled: !isSprintStarted, style: { opacity: isSprintStarted ? 1 : 0.4 }, onClick: () => { stopSprint(); } }, "Stop")),
        plugin.settings.nanowrimoProjectName &&
            reactExports.createElement("div", { id: "nanowrimoProject" }, plugin.settings.nanowrimoProjectName),
        reactExports.createElement("hr", { style: { marginBottom: 0 } }),
        reactExports.createElement("div", { id: "sectionTab", style: { margin: 0, width: '100%' } },
            reactExports.createElement("button", { style: { width: '100%' }, className: `statsTab ${activeTab === 'stats' ? 'active' : ''}`, onClick: () => { setActiveTab('stats'); } }, "Stats"),
            reactExports.createElement("button", { style: { width: '100%' }, className: `goalsTab ${activeTab === 'goals' ? 'active' : ''}`, onClick: () => { setActiveTab('goals'); } }, "Goals")),
        activeTab === 'stats' &&
            reactExports.createElement("div", { id: "statsPanel" },
                totalWordCount > 0 &&
                    reactExports.createElement(reactExports.Fragment, null,
                        reactExports.createElement("div", { className: "sprintTotalWordCount" },
                            "Total Word Count: ",
                            numeral(totalWordCount + plugin.theSprint.getStats().totalWordsWritten).format('0,0')),
                        reactExports.createElement("div", { className: "sprintDailyWordCount" },
                            "Daily Word Count: ",
                            numeral(dailyWordCount + plugin.theSprint.getStats().totalWordsWritten).format('0,0')),
                        reactExports.createElement("div", { className: "sprintCount" },
                            "Sprints: ",
                            numeral(plugin.sprintHistory.length).format('0,0'))),
                statsAvailable &&
                    reactExports.createElement("div", { id: "sprintViewStats" },
                        reactExports.createElement("button", { className: "viewStats", onClick: () => {
                                plugin.showEndOfSprintStatsModal();
                            } }, "View Stats"))),
        activeTab === 'goals' &&
            reactExports.createElement("div", { id: "goalsPanel" },
                reactExports.createElement("div", { className: "dailyGoal" },
                    "Daily Goal: ",
                    numeral(dailyGoal).format('0,0')),
                reactExports.createElement("div", { className: "overallGoal" },
                    "Overall Goal: ",
                    numeral(overallGoal).format('0,0')))));
};

const ICON_NAME = "running-man";
const LEAF_VIEW_DISPLAY_TEXT = "Word Sprint";
const STATS_FILENAME = "stats.json";

const STAT_VIEW_TYPE = "stat-view";
class StatView extends obsidian.ItemView {
    ...
    onOpen() {
        return __awaiter(this, void 0, void 0, function* () {
            reactDomExports.render(reactExports.createElement(PluginContext.Provider, { value: this.plugin },
                reactExports.createElement(StatReactView, null)), this.containerEl.children[1]);
        });
    }
    onClose() {
        return __awaiter(this, void 0, void 0, function* () {
            reactDomExports.unmountComponentAtNode(this.containerEl.children[1]);
        });
    }
}

class ChangeSprintTimeModal extends obsidian.Modal {
    constructor(app, plugin) {
        super(app);
        this.plugin = plugin;
    }
    ...
    onOpen() {
        ...
        new obsidian.Setting(contentEl)
            ...
            text.inputEl.type = 'number';
            text.inputEl.focus();
            text.inputEl.onkeydown = (ev) => __awaiter(this, void 0, void 0, function* () {
                if (this.isEnter(ev)) {
                    ev.preventDefault();
        ...
        new obsidian.Setting(contentEl)
            .addButton((button) => {
            button.setButtonText("Apply").onClick(() => __awaiter(this, void 0, void 0, function* () {
                yield this.applyChange(newSprintLength, useAsDefaultSprintLength);
                this.close();
            }));
        });
...
class WordSprintPlugin extends obsidian.Plugin {
    constructor() {
        super(...arguments);
    ...
    emptyDailyStats() {
        return __awaiter(this, void 0, void 0, function* () {
            this.sprintHistory = this.sprintHistory.filter((hist) => hist.created < obsidian.moment().startOf('day').toDate().valueOf());
            yield this.saveStats();
        });
    }
    convertJsonToCsv(data) {
        ...
        const csvRows = data.map((item) => [
            ...
            item.wordsDeleted,
            item.wordsNet,
            obsidian.moment(item.created).toISOString(),
    ...
    exportStats() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const path = obsidian.normalizePath(`${dir}/${STATS_FILENAME}`);
            let stats;
            const csvPath = obsidian.normalizePath(`${this.app.vault.getRoot().path}/${obsidian.moment().format('YYYY-MM-DD')} - Word Sprint.csv`);
            if (yield adapter.exists(path)) {
                stats = yield adapter.read(path);
                try {
                    const statsAsJson = JSON.parse(stats);
                    yield adapter.write(csvPath, this.convertJsonToCsv(statsAsJson));
                }
                catch (error) {
                    new obsidian.Notice(`Unable to read ${STATS_FILENAME}`);
                    console.error(error);
                }
            }
        });
    ...
    inRange(now) {
        return now >= obsidian.moment().startOf('day').toDate().valueOf()
            && now <= obsidian.moment().endOf('day').toDate().valueOf();
    }
    saveStats() {
        return __awaiter(this, arguments, void 0, function* (statsFilename = STATS_FILENAME) {
            const adapter = this.app.vault.adapter;
            const dir = this.manifest.dir;
            const path = obsidian.normalizePath(`${dir}/${statsFilename}`);
            ...
            try {
                ...
                new obsidian.Notice(`Unable to write to ${statsFilename} file`);
                console.error(error);
            }
        });
    }
            ...
            this.addCommand({
                ...
                editorCallback: (editor) => __awaiter(this, void 0, void 0, function* () {
                    ...
                    if (this.theSprint && this.theSprint.isStarted()) {
                        new obsidian.Notice("Sprint still going, but here's the stats as of this moment");
                    }
                    const stats = this.sprintHistory[this.sprintHistory.length - 1];
                    statsText = `### Latest Word Sprint ${obsidian.moment(stats.created).format('YYYY-MM-DD HH:mm:ss')}\n`;
            ...
            this.addCommand({
                ...
                callback: () => __awaiter(this, void 0, void 0, function* () {
                    if (this.theSprint && this.theSprint.isStarted()) {
                        ...
                        yield this.stopWordSprint();
                    }
                    else {
                        new obsidian.Notice("A new Sprint has started");
    ...
    stopWordSprint() {
        return __awaiter(this, void 0, void 0, function* () {
            if (this.theSprint && this.theSprint.isStarted()) {
                ...
                yield this.saveStats();
                this.theSprint = new SprintRun(this.settings.sprintLength, this.settings.yellowNoticeTimeout, this.settings.redNoticeTimeout);
                new obsidian.Notice(`Word Sprint Cancelled! Total words written: ${sprintRunStat.totalWordsWritten}`);
            }
            else {
                new obsidian.Notice('No Word Sprint running');
            }
        });
    }
    updateNano(count) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                if (projectSession) {
                    new obsidian.Notice(`Updated NaNoWriMo project with latest sprint count: ${count}`);
                }
            }
            catch (error) {
                console.error(error);
                new obsidian.Notice('Error occurred updating NaNoWriMo project with sprint count');
            }
        });
    }
    startButtonUsed() {
    ...
    startSprintCommand() {
        if (this.theSprint && this.theSprint.isStarted()) {
            new obsidian.Notice("Sprint already started! Please stop current sprint if you'd like to reset");
            return;
        }
        ...
        if (this.app.workspace.getActiveViewOfType(obsidian.MarkdownView)) {
            let viewData = this.app.workspace.getActiveViewOfType(obsidian.MarkdownView).getViewData();
        ...
        const sprintInterval = this.theSprint.start(previousWordCount, (status, statusChanged) => {
            ...
            if (this.settings.showEncouragementNotices) {
                ...
                if (hitCount > encouragementNoticeCount) {
                    new obsidian.Notice(this.settings.encouragementText);
                }
            ...
            if (statusChanged) {
                switch (status) {
                    case 'YELLOW':
                        this.settings.showLagNotices && new obsidian.Notice(this.settings.yellowNoticeText);
                        break;
                    case 'RED':
                        this.settings.showLagNotices && new obsidian.Notice(this.settings.redNoticeText);
                        break;
                }
            }
            ...
            window.clearInterval(this.sprintInterval);
            this.statusBarItemEl.setText('');
            new obsidian.Notice(`Word Sprint Complete! Congratulations! Total words written: ${sprintRunStat.totalWordsWritten}`);
    ...
    showChangeSprintTimeModal() {
        if (this.theSprint.isStarted()) {
            new obsidian.Notice("Cannot change sprint time during a sprint!");
        }
        else {
    ...
    showEndOfSprintStatsModal() {
        if (this.theSprint.isStarted()) {
            ...
            new obsidian.Notice("No stats found to show!");
        }
    }
    onunload() {
        return __awaiter(this, void 0, void 0, function* () {
...
module.exports = WordSprintPlugin;
