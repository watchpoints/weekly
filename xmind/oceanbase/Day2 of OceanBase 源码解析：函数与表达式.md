...
在前面《 [OceanBase 源码解读（三）SQL 的一生](https://open.oceanbase.com/articles/1100225)》中讲过，SQL 语句在生成抽象语法树后，经过 resolver 转换解析为 stmt 逻辑执行计划，其中的一个关键部分是表达式的解析。
...
2. 表达式 类型如如何注册的，处理类是如何管理的?
3. parer模块解析的 怎么和具体处理函数关联？
4. 表达式内置函数是什么意思？
5. 
...
## 尝试回答
![image.png](https://cdn.nlark.com/yuque/0/2022/png/215144/1664008792167-a32c7ec5-359f-4c5c-a47b-a17ed6fb4dd1.png#clientId=udbd23bb3-37e7-4&crop=0&crop=0&crop=1&crop=1&errorMessage=unknown%20error&from=paste&height=341&id=ub58fcb4e&margin=%5Bobject%20Object%5D&name=image.png&originHeight=547&originWidth=993&originalType=binary&ratio=1&rotation=0&showTitle=false&size=50445&status=error&style=none&taskId=u7ead6595-296f-4cf1-891a-0a60149ca34&title=&width=618.611312808182)
# 二、MVP
### 2.1 流程图
