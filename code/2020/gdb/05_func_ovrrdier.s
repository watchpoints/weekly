...
## %bb.0:
	...
	.cfi_endproc
                                        ## -- End function
	.globl	__Z4funcif              ## -- Begin function _Z4funcif
	.p2align	4, 0x90
__Z4funcif:                             ## @_Z4funcif
	.cfi_startproc
## %bb.0:
	pushq	%rbp
	.cfi_def_cfa_offset 16
...
L_.str:                                 ## @.str
	.asciz	"func without parameters"

L_.str.1:                               ## @.str.1
	.asciz	"func with one int parameter: "

L_.str.2:                               ## @.str.2
	.asciz	"func with one int parameter and one float parameter"
